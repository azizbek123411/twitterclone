...
class DatabaseProvider extends ChangeNotifier {
  ...
  List<Post> get followingPost => _followingPost;
  ...
  Future<void> loadUserFollowerProfiles(String uid) async {
    try {
      ...
      followersProfile[uid]=followerProfiles;
      notifyListeners();
    } catch (e) {
      print(e);
    }
